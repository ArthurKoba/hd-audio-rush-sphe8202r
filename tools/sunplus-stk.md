...
Stored on branch `files`:

`STK Sunplus Tool Kits 0.2.3 .zip`
...
`STK Sunplus Tool Kit 0.2.3 (rev 8203R) English.exe` successfully recognizes the target `P25D80SH@SOP8.BIN` and exports all 18 module slots.
...
Do not modify vendor executables. New tool versions should be added as new immutable artifacts with source/provenance and SHA-256.
